...
| Données et jeux de données utilisés publiés, sourcées et librement réutilisables  ([partie 4.2](#données-utilisées))        |       X       |       X       |
...
Une fiche Rzine est un document computationnel, alternant texte et code, permettant d’appliquer le paradigme de la programmation lettrée. Sa transcription en HTML nécessite les packages [**`rmarkdown`**](https://rmarkdown.rstudio.com/) et [**`knitr`**](https://yihui.org/knitr/) pour la transformation (ou interprétation) du document Rmd, et [**`rzine`**](https://gitlab.huma-num.fr/rzine/package) pour sa mise en page.

<br/>

## Soumission et évaluation

L'ensemble du processus de soumission et d'évaluation d'une fiche se déroule sur [GitHub](https://github.com//rzine-reviews/). Cela facilite la gestion de versions, permet l'archivage et la visibilité du processus éditorial.
...
<div class="alert alert-success" role="alert">
<b>Une fois le processus d'évaluation terminé, les éditeurices réalisent la mise en page finale de la fiche, son [<b>stockage pérenne</b>](https://github.com/rzine-reviews), sa mise en ligne sur le site [<b>rzine.fr</b>](https://rzine.fr/publication_rzine/), le dépôt d'un [<b>DOI</b>](https://www.doi.org/) et son référencement sur [<b>HAL</b>](https://hal.archives-ouvertes.fr/RZINE).</b></div>


<div class="alert alert-danger" role="alert">
<b>Etre auteurice d'une fiche Rzine, c'est accepter que votre publication (HTML) soit mise à disposition sous les conditions d'utilisation de la [<b>licence Creative Commons BY-SA 4.0</b>](https://creativecommons.org/licenses/by-sa/4.0/deed.fr), que les données et jeux de données associés ont été ou sont rendus publics et que leur réutilisation est libre, et que son code source réponde aux conditions d'utilisation de la licence [<b>MIT</b>](https://opensource.org/licenses/mit-license.php).</b>
