...
## Qu'est-ce c'est ?
La "fiche" est une publication didactique qui présente une méthodologie, un type d'analyse, une fonctionnalité, ou encore le traitement d'un certain type de données avec le langage R. Une fiche peut être principalement technique, méthodologique ou thématique ; elle peut également couvrir ces trois aspects. Elle est évaluée par au moins deux personnes ayant les connaissances thématiques nécessaires.

Le premier objectif d'une fiche consiste à partager de manière pédagogique des méthodes reproductibles applicables en SHS. La publication d'une fiche est ouverte à toutes et tous, quels que soient son statut et sa discipline. Une fiche peut être réalisée à plusieurs et présenter une dimension interdisciplinaire.

Les auteurs et autrices sont libres dans le choix de la problématique et dans la façon d'articuler le contenu. Il est cependant indispensable que le contenu soit correctement contextualisé et intelligible pour l'ensemble des disciplines de SHS. Il est également obligatoire de suivre les règles suivantes :
...
Rzine souhaite promouvoir et partager des usages et pratiques de logiciels et méthodes contribuant à une science plus ouverte et reproductible, et participer à une montée en compétence des disciplines de SHS dans ce domaine. C'est pour cela que l'ensemble du processus d'évaluation se déroule sur [GitHub](https://github.com/) qui repose sur le logiciel de gestion de versions [Git](https://git-scm.com/). Cela ne doit en aucun cas effrayer les auteurs et autrices qui n'ont jamais utilisé Git : de la documentation et une assistance sont fournies par le comité de lecture Rzine... !

## Critères d'acceptation
Afin d'assurer la cohérence et la qualité du contenu des fiches Rzine, plusieurs critères d'acceptation ont été définis. Certains de ces critères peuvent conduire au refus immédiat d'une proposition de fiche par le [comité de lecture](https://rzine.fr/collection/#people), d'autres critères font l'objet d'une analyse contradictoire par plusieurs évaluateur·rice·s.
...
- les données ou jeux de données utilisés dans le cadre de la démonstration doivent obligatoirement être publiés, sourcés et librement réutilisables.

<center>**Les critères d'évaluations**</center>

|                                 |  Editeur·rice·s | Evaluateur·rice·s |
|--------------------------------------------------------------------|:-------------:|:-------------:|
| Respect des consignes éditoriales ([partie 3](#la-rédaction-dune-fiche))    |       X       |               |
...
Etre auteurice d'une fiche Rzine, c'est accepter que :
...
<b>Une fois le processus d'évaluation terminé, les éditeur·rice·s réalisent la mise en page finale de la fiche, son [<b>stockage pérenne</b>](https://github.com/rzine-reviews), sa mise en ligne sur le site [<b>rzine.fr</b>](https://rzine.fr/publication_rzine/), le dépôt d'un [<b>DOI</b>](https://www.doi.org/) et son référencement sur [<b>HAL</b>](https://hal.archives-ouvertes.fr/RZINE) dans la collection RZINE.</b></div>


# Forme et modèle de fiche : le package `rzine`
...
Il est obligatoire de proposer un résumé en début de publication. Ce résumé sera utilisé pour la page de présentation de la fiche sur le site rzine.fr, pour le dépôt Github du code source (cf. [exemple](https://github.com/rzine-reviews/mta_rzine)), du DOI et le référencement sur HAL.
