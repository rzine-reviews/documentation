...
# Le package `rzine`
Le [package `rzine`](https://gitlab.huma-num.fr/rzine/package) fournit le modèle de document numérique (R.T. Pedauque, 2006) associé à une fiche rzine. Il comprend un ensemble de fichiers et une structure de répertoires correspondant à un package R. Il permet de déployer sur votre ordinateur, en syntaxe Rmarkdown, le modèle éditorial `readrzine` d’un notebook R qui sera publié au format statique HTML.
