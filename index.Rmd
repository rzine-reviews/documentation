...
Cela engendre la création d'un fichier du même nom, en format HTML (***index.html***) à la racine de votre répertoire. Il s'agit du fichier index.Rmd mis en page à partir du modèle `readrzine`. 

Voici à quoi ressemble une fiche Rzine HTML vierge :
