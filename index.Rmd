...
**Un modèle de mise en page, ainsi qu'une structure prédéfinie de répertoires, sont mis à disposition par le biais du package** [`rzine`](https://gitlab.huma-num.fr/rzine/package).Son installation du package, ainsi que la création d'une fiche Rzine vierge sont expliqués dans la [partie 2](#le-package-rzine).

Le package est mis à disposition sur un [dépôt de l'organisation Rzine](https://gitlab.huma-num.fr/rzine/package) sur le GitLab Huma-Num. Son installation 
